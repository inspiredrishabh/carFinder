// Car data - saare cars ka data yahan hai
export const carsData = [
  {
    ...
    location: "Mumbai, MH",
    description:
      "Future ka premium SUV, hybrid technology ke saath. Isme milta hai power bhi aur efficiency bhi.",
  },
  {
    id: 2,
    make: "Maruti Suzuki",
    ...
    location: "Delhi, DL",
    description:
      "Electric Swift - India ka favorite hatchback ab electric avatar mein. City driving ke liye perfect.",
  },
  {
    id: 3,
    make: "Tata",
    ...
    description:
      "Improved electric Nexon with better range and features. Indian roads ke liye perfect compact SUV.",
  },
  {
    id: 4,
    make: "Mahindra",
    ...
    location: "Chennai, TN",
    description:
      "Mahindra ka flagship SUV with advanced hydrogen fuel cell technology. Future of SUVs in India.",
  },
  {
    id: 5,
    make: "Honda",
    ...
    description:
      "Honda City - India ka premium sedan, ab next-gen hybrid technology ke saath. Comfort aur luxury dono.",
  },
  {
    id: 6,
    make: "Hyundai",
    ...
    location: "Pune, MH",
    description:
      "Hyundai ki premium electric car with bidirectional charging. Smart features aur style dono ke liye.",
  },
  {
    id: 7,
    make: "Kia",
    ...
    price: 4200000,
    image:
      "https://images.unsplash.com/photo-1603386329225-868f9b1ee6c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    mileage: 600,
    fuelType: "Electric",
    transmission: "Automatic",
    features: [
    ...
    description:
      "Kia ka premium electric SUV. Spacious interior aur futuristic features ke saath.",
  },
  {
    id: 8,
    make: "MG",
    ...
    description:
      "MG ka sporty electric convertible. Style aur technology ka perfect combination.",
  },
];
