      ...
      {isSearching ? (
        <div className="flex flex-col justify-center items-center h-80">
          ...
          <div className="mt-6 text-center">
            <h3 className="text-xl font-semibold text-gray-200 animate-pulse">Aapki futuristic gaadi ki khoj jaari hai</h3>
            <p className="text-gray-400 mt-2">Thoda intezaar karein, hum aapke liye sahi gaadi dhund rahe hain...</p>
          </div>
        </div>
      ) : results.length > 0 ? (
        <>
          ...
          <div className="mt-10 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              Showing <span className="font-medium text-white">{sortedCars.length}</span> of <span className="font-medium text-white">{sortedCars.length}</span> cars
            </p>
            <nav className="flex items-center space-x-2">
              ...
              <a href="#" className="px-3 py-1 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white transition-colors">3</a>
              <span className="px-3 py-1 text-gray-500">...</span>
              <a href="#" className="px-3 py-1 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white transition-colors">10</a>
        ...
        <div className="flex flex-col items-center justify-center h-80 text-center bg-gray-900 rounded-lg border border-dashed border-gray-700 p-8">
          <div className="relative w-24 h-24 mb-4">
            <svg className="w-full h-full text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H11a1 1 0 001-1v-1h3.5a1 1 0 00.8-.4l1.5-2A1 1 0 0018 11h-1.5V8a1 1 0 00-1-1H15V4a1 1 0 00-1-1H3z"></path>
            </svg>
          ...
          <h3 className="text-xl font-semibold text-gray-300 mb-2">Oops! Koi gaadi nahi mili</h3>
          <p className="text-gray-400 max-w-md mx-auto mb-6">
            Aapke search criteria se match karne waali koi future ki gaadi nahi mili. 
            Apne filters ko adjust karein ya search ko thoda aur broad karein.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              ...
              <button className="text-sm text-blue-400 hover:text-blue-300 transition-colors">Electric Cars</button>
              <span className="text-gray-600">•</span>
              <button className="text-sm text-blue-400 hover:text-blue-300 transition-colors">SUVs</button>
              <span className="text-gray-600">•</span>
              <button className="text-sm text-blue-400 hover:text-blue-300 transition-colors">Hybrid</button>
            </div>
          </div>
        </div>
      )}
